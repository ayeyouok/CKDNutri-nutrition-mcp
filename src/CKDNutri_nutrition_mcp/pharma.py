...
# P3（2026-08-23 复审）：扩充药理大类/广义概念词——这些药物别名含类别词（"acei"/
# "arb"/"钾结合剂"/"降钾树脂"/"非钙磷结合剂"/"活性维生素d"/"保钾利尿剂"/"袢利尿剂"/
# "生长激素"等），单独输入会精确命中某一具体药（如"钾结合剂"→聚苯乙烯磺酸钙），
# 漏报同类其他药的高危交互（钠型树脂/环硅酸锆钠的钠负荷、ARB 与 ACEI 区分）。统一
# 排除 → 强制用户输入具体药名（fail-closed 澄清）。注：不笼统加"利尿剂"（过泛），
# 保留"袢利尿剂""保钾利尿剂"这种已足够具体的类别词。
FUZZY_EXCLUDE_ALIASES = {
    "激素", "碳酸", "普利", "沙坦", "铁剂",
    "acei", "arb", "钾结合剂", "降钾树脂", "钙型降钾树脂", "钠型降钾树脂",
    "新型钾结合剂", "非钙磷结合剂", "含钙磷结合剂", "活性维生素d",
    "保钾利尿剂", "袢利尿剂", "生长激素",
}
